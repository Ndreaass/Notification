...
public class MainActivity extends AppCompatActivity {
    ...
    public void doNotification(View view){
        ...
        myNotif.setStyle(new NotificationCompat.BigTextStyle().bigText("Tersedia di Android 8.0 (API level 26) dan lebih tinggi.\u200B\n" +
                                "\n" +
                "set tingkat intrusi, seperti suara dan visibilitas untuk semua notifikasi yang di posting di saluran.\u200B\n" +
                "\n" +
                "Rentang dari IMPORTANCE_NONE(0) hingga IMPORTACE_HIGH(4).\u200B\n" +
                "\n" +
